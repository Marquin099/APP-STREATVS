            ...
            try {
                ...
                if (response.isSuccessful) {
                    ...
                    if (results != null && results.length() > 0) {
                        ...
                        val description = firstResult.optString("overview", item.description ?: "")
                        val rating = firstResult.optDouble("vote_average", 0.0)
                        ...
                        val enriched = item.copy(
                            ...
                            rating = if (rating > 0) String.format("%.1f", rating) else item.rating
                        )
